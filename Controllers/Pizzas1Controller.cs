...
namespace ContosoPizza.Controllers
{
    public class Pizzas1Controller : Controller
    {
        ...
        public Pizzas1Controller(ContosoPizzaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pizza != null ? 
                          ...
                          Problem("Entity set 'ContosoPizzaContext.Pizza'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IsGlutenFree")] Pizza pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IsGlutenFree")] Pizza pizza)
        {
            if (id != pizza.Id)
            {
                return NotFound();
